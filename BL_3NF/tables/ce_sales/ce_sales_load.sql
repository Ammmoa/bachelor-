...
INSERT INTO BL_3NF.CE_SALES (SALE_ID, CUSTOMER_ID, EMPLOYEE_ID, MODEL_ID, PRODUCT_ID, MMR, AMOUNT, DATE_ID, TIME, TA_INSERT_DT, TA_UPDATE_DT, SOURCE_SYSTEM, SOURCE_ENTITY, SOURCE_ID)
