-- in this transaction, start date of added employees are explicitly defined since there is no information in the dataset
BEGIN; 

-- update |same logic but newly added employees start date is defined explicitly|
